...
// LCEDA extension global types — these are injected by the editor runtime.
declare const eda: {
  sys_ToastMessage: {
...
export class ServerManager {
  ...
  static async ensureServerRunning(): Promise<boolean> {
    ...
    eda.sys_ToastMessage.show(
      '请在终端中启动 API 服务器: cd eda_ai_assistant && python -m uvicorn src.api.server:app --host 127.0.0.1 --port 8710',
      8000
    );
